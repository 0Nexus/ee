...
<body>
    <div class="nav">
        <div class="logo">El Mahroussa-tech</div>
        <div class="caption">
    ...
    <section>
        <div class="left">
            <div class="text">
                <h1 >Videos</h1>
                <a href="./sites/Play_PFE/index.php"><button class="b1">Voir les videos</button></a>
            </div>
        ...
        <div class="right">
            <div class="text">
                <h1 >Articles</h1>
                <a href="http://localhost:3000/"><button class="b1" >Voir les articles</button></a>
            </div>
            <div class="overlay"></div>
        </div>
